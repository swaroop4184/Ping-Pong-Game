// Code is written by Swaroop Vishwakarma
...
if (localStorage.getItem("isFirstTime") === "true") {
  ...
  alert(
    "Hello Player! Im Swaroop Developer of this game. \n🟩This is your first time Go and show that you are a real Gamer🟩 \n\nGAME RULES:\n1. To start the Game Press the Enter button \n2. For moving the rod press the left-right arrow key or A&D key "
  );
} else {
  alert(
...
function set_interval() {
  ...
  if (dimension_ball.bottom < 0 || dimension_ball.top > window.innerHeight) {
    ...
    //game over alert
    alert(
      "GAME OVER \n------------------------------\nRod 1 - Current Score of the game is: " +
        rod1_Score +
        "\nRod 2- Current Score of the game is: " +
        rod2_Score +
        "\n------------------------------\nRod 1- Highest Score of the game is: " +
        Find_max_rod1 +
        "\nRod 2- Highest Score of the game is: " +
        Find_max_rod2
    );
    rod1_Score = 0;
    rod2_Score = 0;
  ...
  // when ball hit the Rod 1 this function work
  else if (
  ...
  // when ball hit the Rod2 this funtion work
  else if (
